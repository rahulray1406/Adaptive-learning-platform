...
passport.use(
  new googleStrategy(
    {
      clientID:
        "958559105804-01b7hs7eegahnoo84si2sfu4hmr95901.apps.googleusercontent.com",
        ...
        teacher
          ...
          .then((data) => {
            if (data) {
              ...
              teacher
                .aggregate([
                  { $group: { _id: null, maxid: { $max: "$teacherID" } } },
                ])
                .then((d) => {
                  console.log(d[0]);
                  newreq = d[0].maxid + 1;
                  ...
                  nayTeacher.save().then((ans) => {
                    teacher.findOne({ email: profile.email }).then((data) => {
                      console.log(data);
                      return done(null, data);
                    });
                  });
        ...
        student
          ...
          .then((data) => {
            if (data) {
              ...
              student
                .aggregate([
                  { $group: { _id: null, maxid: { $max: "$studentID" } } },
                ])
                .then((d) => {
                  console.log(d[0]);
                  newreq = d[0].maxid + 1;
                  ...
                  naystudent
                    ...
                    .then((ans) => {
                      ...
                      student.findOne({ email: profile.email }).then((data) => {
                        console.log(data);
                        return done(null, data);
                      });
                    })
